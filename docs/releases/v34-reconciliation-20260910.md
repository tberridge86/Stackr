...
| Palette | Main uses navy `#07145F` for text and feature panels beside purple `#6938F5`. | Use charcoal `#25222D` for text and plum-charcoal `#302938` for feature panels. Retain purple actions, light surfaces, teal positive states and gold accents. |
