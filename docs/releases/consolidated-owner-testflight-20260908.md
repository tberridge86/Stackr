...
| StackR Colour Direction | The existing approved navy, purple, gold, white and lavender palette is preserved. Advice and mockups did not establish a separate completed colour implementation to merge. |
