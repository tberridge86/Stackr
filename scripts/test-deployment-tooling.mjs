...
if (migrationReconciliation.status === 0) {
  ...
  // The repository ledger is sixteen additional migrations ahead of the last
  ...
  // personal-pricing migrations listed below. These
  ...
  assert.equal(reconciliation.localMigrationFileCount, reconciliation.stagingMigrationHistoryCount + 16);
  ...
  assert.deepEqual(localMigrations.slice(-8), [
