...
assert.match(baselineMigrationTrialWorkflow, /group: stackr-staging-database-maintenance/);
assert.match(catalogueTransferWorkflow, /group: stackr-staging-database-maintenance/);
...
assert.match(recoveryWorkflow, /create-staging-migration-release-evidence\.mjs/);
assert.match(recoveryWorkflow, /--expected-count=1/);
assert.match(recoveryWorkflow, /staging-migration-reconciliation\.json/);
assert.match(recoveryWorkflow, /stackr-recovery\/evidence\/\*\.json/);
assert.match(recoveryWorkflow, /stackr-recovery\/evidence\/\*\.txt/);
