...
async function run() {
  ...
  const tcgdexReferenceUrl = 'https://assets.tcgdex.net/ja/sv1/001/low.webp';
  ...
  assert.doesNotMatch(JSON.stringify([...values.values()]), /assets\\.tcgdex\\.net/, 'controlled references never enter local recovery storage');
