...
assert.throws(() => attestGatewayDoIdentity(version, { expectedId: '', expectedNamespace: namespace }), /expected_version_id_invalid/);
assert.throws(() => attestGatewayDoIdentity(version, { expectedId: id, expectedNamespace: 'invalid' }), /expected_namespace_invalid/);
