...
const binders = [
  { id: 'b2', user_id: 'user-a', name: 'Second', type: 'custom', language: 'ja', sort_order: 2, created_at: '2026-01-02' },
...
async function main() {
  ...
  console.log('Collection export: account isolation, bounded paging, failure and cancellation checks passed.');
}
