...
const visibleCodeStart = explore.indexOf('const chineseSetDisplayCode =');
const visibleCodeEnd = explore.indexOf('const hasExistingBinder', visibleCodeStart);
assert.ok(visibleCodeStart >= 0 && visibleCodeEnd > visibleCodeStart, 'The printed-code display block must exist.');
