...
revoke all on function catalog.catalogue_activation_readiness(uuid) from service_role;
...
drop function if exists catalog.catalogue_activation_readiness(uuid);
