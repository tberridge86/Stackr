...
export const CHINESE_SET_TRANSLATION_DRAFTS_BY_LANGUAGE: Record<'zh-cn' | 'zh-tw', Record<string, { nativeName: string; normalizedNativeName: string; englishTranslation: string }>> = {
  "zh-cn": {
    "cbb1c": {
      "nativeName": "宝石包 第一卷",
