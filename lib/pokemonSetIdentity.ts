const SET_LANGUAGE_PREFIX = /^(?:en|ja|jp|jpn|ko|kr|zh-cn|zh_cn|zhcn|zh-hans|zh_hans|zhhans|zh-sg|zh_sg|zhsg|zh-tw|zh_tw|zhtw|zh-hant|zh_hant|zhhant|zh):/i;
...
export function getPokemonSetLanguageFromPrefixedId(setId?: string | null) {
  ...
  if (prefix === 'ko' || prefix === 'kr') return 'ko' as const;
