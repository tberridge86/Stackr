...
const JAPANESE_SET_LOGOS_BY_KEY: Record<string, JapaneseSetLogoMatch> = {
  ...
  "svls": {
    key: "svls",
    normalizedKey: "svls",
    name: "Stellar Ceruledge ex Starter Set",
    code: "SVLS",
    source: require('../assets/rev2/11-japanese-set-logo/logos/svls.png') as ImageSourcePropType,
  },
  "svln": {
    key: "svln",
    normalizedKey: "svln",
    name: "Stellar Sylveon ex Starter Set",
    code: "SVLN",
    source: require('../assets/rev2/11-japanese-set-logo/logos/svln.png') as ImageSourcePropType,
  },
  "svk": {
    key: "svk",
    normalizedKey: "svk",
    ...
    code: "SVK",
    source: require('../assets/rev2/11-japanese-set-logo/logos/svk.png') as ImageSourcePropType,
  },
  "pcg1": {
    key: "pcg1",
    normalizedKey: "pcg1",
    ...
    code: "PCG1",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg1.png') as ImageSourcePropType,
  },
  "pcg2": {
    key: "pcg2",
    normalizedKey: "pcg2",
    ...
    code: "PCG2",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg2.png') as ImageSourcePropType,
  },
  "pcg3": {
    key: "pcg3",
    normalizedKey: "pcg3",
    ...
    code: "PCG3",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg3.png') as ImageSourcePropType,
  },
  "pcg4": {
    key: "pcg4",
    normalizedKey: "pcg4",
    ...
    code: "PCG4",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg4.png') as ImageSourcePropType,
  },
  "pcg5": {
    key: "pcg5",
    normalizedKey: "pcg5",
    name: "Mirage Forest",
    code: "PCG5",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg5.png') as ImageSourcePropType,
  },
  "pcg6": {
    key: "pcg6",
    normalizedKey: "pcg6",
    ...
    code: "PCG6",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg6.png') as ImageSourcePropType,
  },
  "pcg7": {
    key: "pcg7",
    normalizedKey: "pcg7",
    name: "Holon Phantom",
    code: "PCG7",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg7.png') as ImageSourcePropType,
  },
  "pcg8": {
    key: "pcg8",
    normalizedKey: "pcg8",
    ...
    code: "PCG8",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg8.png') as ImageSourcePropType,
  },
  "pcg9": {
    key: "pcg9",
    normalizedKey: "pcg9",
    ...
    code: "PCG9",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg9.png') as ImageSourcePropType,
  },
  "pcg10": {
    key: "pcg10",
    normalizedKey: "pcg10",
    ...
    code: "PCG10",
    source: require('../assets/rev2/11-japanese-set-logo/logos/pcg10.png') as ImageSourcePropType,
  },
  "adv2": {
    key: "adv2",
    normalizedKey: "adv2",
    ...
    code: "ADV2",
    source: require('../assets/rev2/11-japanese-set-logo/logos/adv2.png') as ImageSourcePropType,
  },
  "adv3": {
    key: "adv3",
    normalizedKey: "adv3",
    ...
    code: "ADV3",
    source: require('../assets/rev2/11-japanese-set-logo/logos/adv3.png') as ImageSourcePropType,
  },
  "e3": {
    key: "e3",
    normalizedKey: "e3",
    ...
    code: "E3",
    source: require('../assets/rev2/11-japanese-set-logo/logos/e3.png') as ImageSourcePropType,
  },
  "e4": {
    key: "e4",
    normalizedKey: "e4",
    name: "Split Earth",
    code: "E4",
    source: require('../assets/rev2/11-japanese-set-logo/logos/e4.png') as ImageSourcePropType,
  },
  "e5": {
    key: "e5",
    normalizedKey: "e5",
    ...
    code: "E5",
    source: require('../assets/rev2/11-japanese-set-logo/logos/e5.png') as ImageSourcePropType,
  },
  "web1": {
    key: "web1",
    normalizedKey: "web1",
    ...
    code: "WEB1",
    source: require('../assets/rev2/11-japanese-set-logo/logos/web1.png') as ImageSourcePropType,
  },
};
